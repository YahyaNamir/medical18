...
const BodyFront = ({selectedLocation, locationClicked}) => {
  return (
    <Svg width={364} height="100%">
      <Path
        stroke="#777"
        id="face"
        onPress={() => locationClicked('visage')}
        fill={selectedLocation.includes('visage') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_eye"
        onPress={() => locationClicked('oeil droite')}
        fill={selectedLocation.includes('oeil droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_eye"
        onPress={() => locationClicked('oeil gauche')}
        fill={selectedLocation.includes('oeil gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_ear"
        onPress={() => locationClicked('oreille droite')}
        fill={selectedLocation.includes('oreille droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_ear"
        onPress={() => locationClicked('oreille gauche')}
        fill={selectedLocation.includes('oreille gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="nose"
        onPress={() => locationClicked('nez')}
        fill={selectedLocation.includes('nez') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="mouth"
        onPress={() => locationClicked('bouche')}
        fill={selectedLocation.includes('bouche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="neck"
        onPress={() => locationClicked('cou')}
        fill={selectedLocation.includes('cou') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="chest"
        onPress={() => locationClicked('poitrine')}
        fill={selectedLocation.includes('poitrine') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="abdomen"
        onPress={() => locationClicked('abdomen')}
        fill={selectedLocation.includes('abdomen') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_hip"
        onPress={() => locationClicked('psoas gauche')}
        fill={selectedLocation.includes('psoas gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_hip"
        onPress={() => locationClicked('psoas droite')}
        fill={selectedLocation.includes('psoas droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="bassin_1_"
        onPress={() => locationClicked('bassin')}
        fill={selectedLocation.includes('bassin') ? 'red' : '#fff'}
        d="M196.6,334.3c0,0-15.5-8.9-26.8,0l9.3,15.6c0,0,1.3-2.6,6.7-0.8L196.6,334.3z"
      />
      <Path
        stroke="#777"
        id="right_shoulder"
        onPress={() => locationClicked('épaule droite')}
        fill={selectedLocation.includes('épaule droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_shoulder_1_"
        onPress={() => locationClicked('épaule gauche')}
        fill={selectedLocation.includes('épaule gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_arm"
        onPress={() => locationClicked('bras droite')}
        fill={selectedLocation.includes('bras droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_arm_1_"
        onPress={() => locationClicked('bras gauche')}
        fill={selectedLocation.includes('bras gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_elbow"
        onPress={() => locationClicked('coude droite')}
        fill={selectedLocation.includes('coude droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_elbow_1_"
        onPress={() => locationClicked('coude gauche')}
        fill={selectedLocation.includes('coude gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_forearm_1_"
        onPress={() => locationClicked('avant-bras droite')}
        fill={selectedLocation.includes('avant-bras droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_forearm"
        onPress={() => locationClicked('avant-bras gauche')}
        fill={selectedLocation.includes('avant-bras gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_wrist"
        onPress={() => locationClicked('poignet droite')}
        fill={selectedLocation.includes('poignet droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_wrist"
        onPress={() => locationClicked('poignet gauche')}
        fill={selectedLocation.includes('poignet gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_hand"
        onPress={() => locationClicked('main droite')}
        fill={selectedLocation.includes('main droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_hand"
        onPress={() => locationClicked('main gauche')}
        fill={selectedLocation.includes('main gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_knee"
        onPress={() => locationClicked('genou droite')}
        fill={selectedLocation.includes('genou droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_knee"
        onPress={() => locationClicked('genou gauche')}
        fill={selectedLocation.includes('genou gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_leg"
        onPress={() => locationClicked('jambe droite')}
        fill={selectedLocation.includes('jambe droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_leg"
        onPress={() => locationClicked('jambe gauche')}
        fill={selectedLocation.includes('jambe gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_ankle"
        onPress={() => locationClicked('cheville droite')}
        fill={selectedLocation.includes('cheville droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_ankle"
        onPress={() => locationClicked('cheville gauche')}
        fill={selectedLocation.includes('cheville gauche') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="right_foot"
        onPress={() => locationClicked('pied droite')}
        fill={selectedLocation.includes('pied droite') ? 'red' : '#fff'}
      ...
      <Path
        stroke="#777"
        id="left_foot"
        onPress={() => locationClicked('pied gauche')}
        fill={selectedLocation.includes('pied gauche') ? 'red' : '#fff'}
      ...
      />
      <Path
        onPress={() => locationClicked('quadrieceps-bas droite')}
        class="st0"
        stroke="#777"
        fill={
          selectedLocation.includes('quadrieceps-bas droite') ? 'red' : '#fff'
        }
      ...
      />
      <Path
        onPress={() => locationClicked('quadrieceps-medium droite')}
        class="st0"
        stroke="#777"
        fill={
          selectedLocation.includes('quadrieceps-medium droite')
            ? 'red'
            : '#fff'
        }
      ...
      />
      <Path
        onPress={() => locationClicked('adducteur gauche')}
        class="st0"
        stroke="#777"
        fill={selectedLocation.includes('adducteur gauche') ? 'red' : '#fff'}
      ...
      />
      <Path
        onPress={() => locationClicked('quadrieceps-medium gauche')}
        class="st0"
        stroke="#777"
        fill={
          selectedLocation.includes('quadrieceps-medium gauche')
            ? 'red'
            : '#fff'
        }
      ...
      />
      <Path
        onPress={() => locationClicked('quadrieceps-bas gauche')}
        class="st0"
        stroke="#777"
        fill={
          selectedLocation.includes('quadrieceps-bas gauche') ? 'red' : '#fff'
        }
      ...
      />
      <Path
        onPress={() => locationClicked('adducteur droite')}
        class="st0"
        stroke="#777"
        fill={selectedLocation.includes('adducteur droite') ? 'red' : '#fff'}
      ...
      />
      <Path
        onPress={() => locationClicked('rotule droite')}
        class="st0"
        stroke="#777"
        fill={selectedLocation.includes('rotule droite') ? 'red' : '#fff'}
      ...
      />
      <Path
        onPress={() => locationClicked('rotule gauche')}
        class="st0"
        stroke="#777"
        fill={selectedLocation.includes('rotule gauche') ? 'red' : '#fff'}
      ...
      <Path
        onPress={() => locationClicked('quadrieceps-haut droite')}
        stroke="#777"
        fill={
          selectedLocation.includes('quadrieceps-haut droite') ? 'red' : '#fff'
        }
        class="st0"
	...
	C159.9,323.4,146.6,311.1,137.7,303.2z"
      />
      <Path
        fill={selectedLocation.includes('abducteur droite') ? 'red' : '#fff'}
        onPress={() => locationClicked('abducteur droite')}
        stroke="#777"
        class="st0"
	...
	c0.1,0.5,0.3,0.9,0.5,1.3C134.5,328.1,137,312.5,137.7,303.2z"
      />
      <Path
        fill={selectedLocation.includes('abducteur gauche') ? 'red' : '#fff'}
        onPress={() => locationClicked('abducteur gauche')}
        stroke="#777"
        class="st0"
	...
	c-0.1,0.5-0.3,0.9-0.5,1.3C231.5,328.8,229,313.2,228.3,303.8z"
      />
      <Path
        onPress={() => locationClicked('quadrieceps-haut gauche')}
        class="st0"
        stroke="#777"
        fill={
          selectedLocation.includes('quadrieceps-haut gauche') ? 'red' : '#fff'
        }
